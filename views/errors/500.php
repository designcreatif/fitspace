...
<main class="flex-grow flex items-center justify-center pt-24 pb-12 px-margin-mobile text-center">
    <div class="max-w-lg space-y-6">
        <span class="inline-block px-4 py-1 bg-error text-on-error font-label-md rounded-full uppercase tracking-widest">Erreur 500</span>
        <h1 class="font-headline-xl text-headline-xl">Erreur serveur</h1>
        <p class="font-body-lg text-secondary">Une erreur interne s'est produite. Veuillez réessayer plus tard.</p>
        <?php if (!empty($errorMessage)): ?>
        <p class="font-label-sm text-error"><?= e($errorMessage) ?></p>
        <?php endif; ?>
